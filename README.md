...
<table>
  <tr>
    <td width="220px" valign="top" align="center">
      <h3><a href="https://github.com/catherine0911/Data-Science-Portfolio_Thu-Pham/tree/main/Projects/Rental%20Occupancy%20Prediction">
      Rental Property Occupancy Prediction</a></h3>
      <img src="Image/Forecasting-Occupancy.jpeg" alt="Rental Occupancy Prediction" width="180"/><br><br>
    </td>
    <td valign="middle">
      <strong>Rank: 17/170 (Top 10%), MAE: 0.1386</strong><br>
      I developed a regression pipeline to predict rental occupancy rates using a dataset of property features and amenities for a competition in Machine Learning Course. To prepare the data, I implemented KNN Imputation for missing spatial features and Target Encoding with 5-fold cross-validation to handle high-cardinality categorical variables without data leakage. I engineered additional predictors through geospatial binning of coordinates and regex-based parsing of amenity strings. After applying Variance Thresholding and correlation analysis for feature selection, I trained a weighted ensemble of <b>XGBoost, LightGBM, and CatBoost</b>. The final predictions were generated by averaging the models using <b>inverse-variance weighting</b> based on their 10-fold cross-validation performance, resulting in a 17th-place finish out of 170 participants.
      </ul>
    </td>
  </tr>
</table>
